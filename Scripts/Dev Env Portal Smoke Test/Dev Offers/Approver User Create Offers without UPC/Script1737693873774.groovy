...
WebUI.setText(findTestObject('Object Repository/Page_Birdzi/textarea__ng-untouched ng-dirty ng-valid'), 'Description')

WebUI.setText(findTestObject('Object Repository/Page_Birdzi/input_Offer Name_ng-untouched ng-pristine ng-valid'), 'Offer Name')
