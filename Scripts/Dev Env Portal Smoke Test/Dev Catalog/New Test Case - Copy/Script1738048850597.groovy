...
// Print the name or text of the randomly selected item
String itemText = WebUI.getText(randomItem)  // If it has text, replace with appropriate method to get the item's text or name
println("Randomly clicked item: " + itemText)
//---------------------------------------------------------------------------------------------------------------------
